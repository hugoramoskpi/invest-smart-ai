...
class InvestAgent:
    def __init__(self):
        ...
        if google_key and google_key != "sua_chave_do_google_aqui":
            # Usando o modelo 2.0-flash que confirmamos estar disponível na sua conta
            self.llm = ChatGoogleGenerativeAI(model="gemini-2.0-flash", google_api_key=google_key)
        elif openai_key:
